...
type Props = { isDate?: boolean, mask?: string, money?: boolean } & React.ComponentProps<"input">


const Input = React.forwardRef<HTMLInputElement, Props>(({ className, isDate = false, money = false, onChange = () => { }, mask, type, ...props }, ref) => {
